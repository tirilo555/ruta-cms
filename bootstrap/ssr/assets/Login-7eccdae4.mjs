...
import { _ as _sfc_main$2, a as _sfc_main$6 } from "./PrimaryButton-0a8c9345.mjs";
import { _ as _sfc_main$3, a as _sfc_main$4, b as _sfc_main$5 } from "./TextInput-9a42a728.mjs";
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("Themes/July2023/resources/js/Components/Checkbox.vue");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$2, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Log in site" }, null, _parent2, _scopeId));
            if (__props.status) {
            ...
            if (__props.canResetPassword) {
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(` Forgot your password? AAAAAA? `);
                  } else {
                    return [
                      createTextVNode(" Forgot your password? AAAAAA? ")
                    ];
                  }
                }),
                _: 1
            ...
            return [
              createVNode(unref(Head), { title: "Log in site" }),
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("Themes/July2023/resources/js/Pages/Auth/Login.vue");
